...
namespace DataStructures
{
    public class SkipList : IDictionary
    {
        ...
        private const double LevelUpProbability = 0.5;

        // The skip list header. It also serves as the NIL node.
        internal SkipListNode nillNode = new SkipListNode(MaxLevel);
        ...
        private int GetNewLevel()
        {
            ...
            while (random.NextDouble() < LevelUpProbability && level < MaxLevel &&
                level <= listLevel)
            {
                level++;
            }
        ...
        /// </returns>
        /// <remarks>
        private bool Search(object key, out SkipListNode curr)
        {
            SkipListNode[] dummy = new SkipListNode[MaxLevel];
        ...
        /// Returns true if the specified key is in the SkipList.
        /// </returns>
        private bool Search(object key, SkipListNode[] update)
        {
            SkipListNode curr;
